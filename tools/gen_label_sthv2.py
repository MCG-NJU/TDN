...
if __name__ == '__main__':
    dataset_name = '/workspace/mnt/storage/kanghaidong/khddata/labels/something-something-v2'  # 'jester-v1'
    ...
    for (filename_input, filename_output) in zip(files_input, files_output):
        ...
        for i in range(len(folders)):
            ...
            dir_files = os.listdir(os.path.join('/workspace/mnt/storage/kanghaidong/khddata/20bn-something-something-v2/20bn-something-something-v2-frames', curFolder))
